...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipe.original_source'
        db.add_column('cookbook_recipe', 'original_source',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipe.original_source'
        db.delete_column('cookbook_recipe', 'original_source')
    ...
    models = {
        ...
        'cookbook.recipe': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'original_source': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
